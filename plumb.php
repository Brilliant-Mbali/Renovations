        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <img src="img/plumbing.jpg" alt="" width=640px height=500px>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="h-100">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item"> Preparing Cost Estimates</li>
                        <li class="list-group-item"> Install Pipes And Tubes</li>
                        <li class="list-group-item"> Testing Facilities For Leaks</li>
                        <li class="list-group-item">Repair And Maintain Various Appliances</li>
                      </ul>
                    </div>
                </div>
            </div>
