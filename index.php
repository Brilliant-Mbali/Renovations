                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-12 col-lg-10">
                                    ...
                                    <h3 class="text-light mb-3 animated slideInDown">
                                        RETROFIT RENOVATIONS</h3>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row align-items-centre">
            <div data-wow-delay="0.1s">
                ...
                <h2><strong>Unique Solutions For Residential</strong> </h2>
                <p class="lead">Retrofit Renovations aims to address the challenges faced by homeowners by offering a comprehensive
                    and
                    client centric approach to project management. We prioritize clear and transparent communication at every stage
                    of the renovation and construction process, ensuring that homeowners are kept informed and involved in decision
                    making. Our team consists of experienced and skilled professionals who are dedicated to delivering high quality
                    workmanship and adhering to strict timelines.</p>
            </div>
        </div>
    </div>
    <!-- Service Start -->
            ...
            <div class="row g-5 align-items-end mb-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="border-start border-5 border-primary ps-4">
                        ...
                        <h2><strong>Renovation Solutions</strong></h2>
                    </div>
                </div>
            </div>
