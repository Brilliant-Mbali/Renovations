                        ...
                        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="w-100" src="img/tiling-1.jpg" alt="Image" height="500px">
                                </div>
                                <div class="carousel-item">
                                    <img class="w-100" src="img/tiling-main.jpg" alt="Image" height="500px">
                                </div>
                                <div class="carousel-item">
                                    <img class="w-100" src="img/tiling-2.jpg" alt="Image" height="500px">
                                </div>
                                <div class="carousel-item">
                                    <img class="w-100" src="img/tiling-3.jpg" alt="Image" height="500px">
                                </div>
                                <div class="carousel-item">
                                    <img class="w-100" src="img/tiling-4.jpg" alt="Image" height="500px">
                                </div>
                                <div class="carousel-item">
                                    <img class="w-100" src="img/tiling-5.jpg" alt="Image" height="500px">
                                </div>
                            </div>
